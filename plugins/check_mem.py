...
def main():
    ...
    print ("%s (Percent free: %s%%, Total: %s MB, Used: %s MB, Buffers: %s MB, Cached: %s MB)" % (msg, p_free, (mem.total / 1024 / 1024), (mem.used / 1024 / 1024),
                                                                                               (mem.buffers / 1024 / 1024), (mem.cached / 1024 / 1024)))
    sys.exit(r)

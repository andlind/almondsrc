...
void process_almond_heal(ConfVal);
void process_almond_log_heal(ConfVal);
void process_almond_port(ConfVal);
void process_almond_standalone(ConfVal);
void process_collector_metrics(ConfVal);
void process_collector_metadata(ConfVal);
void process_collector_server(ConfVal);
void process_collector_verbose(ConfVal);
...
void process_enable_collector(ConfVal);
...
void process_inventory_file_name(ConfVal);
...
void process_mail_alerts(ConfVal);
...
void process_save_inventory(ConfVal);
void process_slack_alerts(ConfVal);
...
extern bool collector_metrics;
extern bool collector_server;
extern bool collector_metadata;
extern bool collector_verbose;
extern bool enableCollector;
extern bool enableIamAud;
extern bool enableIamRoles;
extern bool local_api;
extern bool save_inventory;
extern bool use_push;
extern bool use_metrics_push;
extern bool send_alerts_to_email;
extern bool send_alerts_to_slack;
...
extern size_t inventoryfilename_size;

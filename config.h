...
/* Define to 1 if you have the <jwt.h> header file. */
#define HAVE_JWT_H 1
...
/* Name of package */
#define PACKAGE "almond"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "andreas.lindell@almondmonitor.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "almond"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "almond 0.9.28"
